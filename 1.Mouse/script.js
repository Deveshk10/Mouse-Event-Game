...
mClick.addEventListener("click", function (e) {
    ...
    msgEl.textContent = "You are clicking the mouse 🤪";
});
...
mOver.addEventListener("mouseover", function (e) {
    msgEl.textContent="You are over the mouse"
})
mDown.addEventListener("mousedown", function (e) {
    msgEl.textContent="You are down the mouse"
})